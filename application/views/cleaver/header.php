    ...
    <head>
        <title>Encuesta Cleaver</title><!-- Required meta tags -->
            ...
            <style>
                ...
                .reactivo{
                    background-color:#fefefe;border:1px solid #4cbed8;
                    width:410px;height:50px;padding-top:10px;}
                .mas{background-color:#fefefe;border:1px solid #4cbed8;width:50px;
                    height:50px;text-align:center;cursor:pointer;}
                .menos{background-color:#fefefe;border:1px solid #4cbed8;width:50px;
                    height:50px;text-align:center;cursor:pointer;}
